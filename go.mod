...
require (
	...
	github.com/tobycroft/AossGoSdk v1.5.4
	github.com/tobycroft/Calc v1.2.0
	github.com/tobycroft/gorose-pro v1.7.3
)
...
require (
	...
	github.com/tobycroft/HttpRequest v1.1.5 // indirect
